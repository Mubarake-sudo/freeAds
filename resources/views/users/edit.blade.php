        ...
        <div class="form-page-layout form-page-sm">
            <div class="form-page-header">
                ...
                <div class="form-header-grid">
                    ...
                    @if($user->avatar_url)
                        <img src="{{ $user->avatar_url }}" alt="Avatar" class="user-avatar user-avatar-lg">
                    @else
            ...
            <div class="form-card">
                <form method="POST" action="{{ route('profile.update') }}" class="auth-form" id="edit-profile-form" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <svg class="input-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.58-7 8-7s8 3 8 7"/></svg>
