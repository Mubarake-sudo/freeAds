...
@section('meta_description', 'Publiez votre annonce gratuitement sur FreeAds.')
    ...
    <div class="container">
        <div class="form-page-layout">
            ...
            <div class="form-page-header">
                ...
                <p class="page-subtitle">Remplissez le formulaire ci-dessous pour publier votre annonce gratuitement.</p>
            </div>

            <form method="POST" action="{{ route('ads.store') }}" enctype="multipart/form-data" class="ad-form" id="create-ad-form" novalidate>
                @csrf
                ...
                <div class="form-card">
                    ...
                    <div class="form-group">
                        <label for="title" class="form-label">Titre de l'annonce <span class="required">*</span></label>
                        <input
                            type="text"
                            id="title"
                            name="title"
                            ...
                            placeholder="Ex: iPhone 14 Pro 256Go - Très bon état"
                            required
                            minlength="5"
                            maxlength="150"
                        >
                        <p class="form-hint">Soyez précis et descriptif (min. 5 caractères).</p>
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-hint">Min. 20 caractères. Soyez précis pour attirer plus d'acheteurs.</p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <input
                                    ...
                                    name="price"
                                    value="{{ old('price') }}"
                                    class="form-input {{ $errors->has('price') ? 'input-error' : '' }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-upload-area" id="file-upload-area">
                            ...
                            <div class="file-upload-placeholder" id="file-placeholder">
                                ...
                                <p><strong>Cliquez ou glissez</strong> une photo ici</p>
                ...
                <div class="form-actions">
                    <a href="{{ route('home') }}" class="btn btn-outline" id="cancel-create">Annuler</a>
                    <button type="submit" class="btn btn-primary btn-lg" id="submit-create">
